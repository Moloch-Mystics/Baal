...
contract Baal {
    ...
    struct Proposal { /*Baal proposal details*/
        ...
        bool[5] flags; /*flags for proposal type & status - [action, member, period, whitelist, sponsor]*/
    ...
    *****************/
    ...
    function submitProposal(
        ...
        bool[5] memory flags; /*plant `flags` - [action, member, period, whitelist, sponsor]*/
        ...
        if (balanceOf[msg.sender] != 0){
            flags[4] = true; /*if a member, self-sponsor*/
        } 
        ...
        unchecked {
            ...
            proposals[proposalCount] = Proposal( /*push params into proposal struct - start voting period timer if member submission*/
                votingPeriod,
                flags[4] ? uint32(block.timestamp) : 0, 
                flags[4] ? uint32(block.timestamp) + votingPeriod : 0, 
